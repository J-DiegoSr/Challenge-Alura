...
function btnDesencriptar() {
    manejarTexto(desencriptar, "Texto desencriptado con éxito", "./assets/desencriptado.png");
}

function manejarTexto(funcion, mensajeTitulo, imagenMuneco) {
    const texto = textArea.value;
    const areaEncriptada = document.querySelector('.contenedor_principal_area_encriptada');
